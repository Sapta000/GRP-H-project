...
<html lang="en">
    <head>
        ...
        <link href="css/dh2.css" rel="stylesheet">    
        <link href="css/dh3.css" rel="stylesheet">
        <link href="css/dh4.css" rel="stylesheet"> 
        <link href="css/dh5.css" rel="stylesheet"> 
    ...
    <body id="top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <!--<form role="form" action="mailto:rohitnandy2001@gmail.com" method="post" enctype="text/plain" >-->
                                <form  action="https://formspree.io/f/xrgvkeyp" method="post"  >
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <input type="telephone" name="phone" id="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" placeholder="Phone: 123-456-7890" required>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            ...
                                            <input type="submit" class="form-control" id="submit-button" value="Book Now" />
                                        </div>
                                    </div>
                                </form>
        ...
        <script src="js/dh1.js"></script>
        <script src="js/dh2.js"></script>
        <script src="js/dh3.js"></script>
        <script src="js/dh4.js"></script>
        <script src="js/dh5.js"></script>
