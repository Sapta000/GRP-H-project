<%-- 
    ...
    Created on : 06-Mar-2023, 2:33:47 pm
    Author     : Rohit Nandy
--%>
                            ...
                            <div class="prescription_form">
                                <table class="prescription" data-prescription_id="<?php echo $presc->prescription_id; ?>" border="1">                                        <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="doctorName" type="text" id="doctorName" placeholder="Doctor Name" ><br>
                                                <br>
                                                <input name="speciality" type="text" id="speciality" placeholder="Speciality" ><br>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                ...
                                                <input name="patientName" type="text" id="patientName" placeholder="Patient Name" ><br>
                                                <br>
                                                <input name="gender" type="text" id="gender" placeholder="Patient Gender" ><br>
                                                <br>
                                                <input name="age" type="text" id="age" placeholder="Patient Age" ><br>

                                                <!--PatientId:<input name="patientId" type="text" id="fname"  ><br>-->
                                            ...
                                            <td width="40%">
                                                <div class="desease_details">
                                                    <div class="symptoms">
                                                        ...
                                                        <input name="symptoms" type="text" id="symptoms" placeholder="Patient Symptoms" ><br>
                                                    ...
                                                    <div class="tests">
                                                        ...
                                                        <input name="tests" type="text" id="tests" placeholder="Patient Tests" ><br>
                                                    ...
                                                    <div class="advice">
                                                        ...
                                                        <input name="advice" type="text" id="advice" placeholder="Patient Advice" ><br>
                                                ...
                                                <div class="Medicine">
                                                    <div>
                                                        ...
                                                        <select name="dosage" type="text" id="timing" min="1" class="inner-item" required>
                                                            ...
                                                            <option value="1+0+0">1+1+0</option>
...
//                alert(time);
                var params = {
                    ...
                    to_name: document.getElementById('patientName').value,
                    from_name: document.getElementById('doctorName').value,
...
//                alert(params);
                emailjs.send("service_dhg75gf", "template_l5t155m", params);
