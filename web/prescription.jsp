...
<script src="js/presciption.js"></script>

<!--<div id="makepdf">-->
<button id="button">Generate PDF</button>
<!--<div id="makepdf">-->

<div class="wrapper" id="makepdf">
                    ...
                    <td colspan="2">
                        <div class="header">
                            ...
                            <div class="credentials">
                                <h4>Doctor Name</h4>
                                <p>Exavalu Health Care</p>
                                <small>Kolkata Sector 5</small>
                                <br />
                                <small>Mb. 088839 28258</small>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="desease_details">
                            <div class="symptoms">
                                ...
                                <ul class="symp" data-toggle="tooltip" data-placement="bottom" title="Click to edit."
                                    contenteditable="true" name="symptoms">
                                </ul>
                            ...
                            <div class="tests">
                                ...
                                <ul class="tst" data-toggle="tooltip" data-placement="bottom" title="Click to edit."
                                    contenteditable="true" name="tests">
                                </ul>
                            ...
                            <div class="advice">
                                ...
                                <p class="adv_text" style="outline: 0;" data-toggle="tooltip"
                                   data-placement="bottom" title="Click to edit." contenteditable="true" name="advice">
                                </p>
...
<script id="new_medicine" type="text/template">
    <div class="med">
                ...
                title="Click to edit..." placeholder="Enter medicine name" name="medicine"/>
                ...
                <select class="sc" data-med_id="{{med_id}}" name="routine">
                <option value="1+1+1" selected>1+1+1</option>
                <option value="1+0+1">1+0+1</option>
                <option value="0+1+1">1+0+0</option>
                <option value="1+0+0">0+1+1</option>
                <option value="0+0+1">1+1+0</option>
                ...
                <select class="meal" data-med_id="{{med_id}}" name="time">
                ...
                Take for <input class="med_period" type="text" data-med_id="{{med_id}}" name="duration"
