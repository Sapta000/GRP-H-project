...
<html>
    ...
    <div id="example">
        ...
        <!-- search-->
        <form class="form-inline"action="SearchDoctor" method="get">
            <div class="container" >
                <div class="row">
                    <div class="form-control col-sm">
                        <input class="form-control" type="text" placeholder="Enter Doctor Email" name="email">
                    </div>
                            ...
                            <div class="fixed-table-body">
                                <table id="table" data-height="400" data-virtual-scroll="true" class="table table-bordered table-hover" style="margin-top: -9.5px;">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items='${DoctorList1}' var="doctor">
                                            <tr>
...
<!--                                    <td><a href="EditPatientStatus?patientId=${doctor.doctorId}">Edit Status</a></td>-->
                                            </tr>
                                        </c:forEach>
